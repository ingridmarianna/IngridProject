...
- (void)inputText:(NSString *)text {
    ...
    if ([text  isEqualToString:@"love" ]||[text  isEqualToString:@"applaud" ]||[text  isEqualToString:@"weico" ]||[text  isEqualToString:@"unicorn" ]||[text  isEqualToString:@"unicorn2" ]||[text  isEqualToString:@"panda" ]||[text  isEqualToString:@"firefox" ]||[text  isEqualToString:@"ballon" ]||[text  isEqualToString:@"ballon1" ]||[text  isEqualToString:@"blueapple" ]||[text  isEqualToString:@"Thank you" ]||[text  isEqualToString:@"elephant" ]||[text  isEqualToString:@"firefoxhead" ]||[text  isEqualToString:@"firemark" ]||[text  isEqualToString:@"hoshin" ]||[text  isEqualToString:@"bear1" ]||[text  isEqualToString:@"bluefirefoxhead" ]){

        NSTextAttachment *textAttachment = [[NSTextAttachment alloc] init];
        textAttachment.image = [UIImage imageNamed:text];
        ...
        UITextView *textView = (UITextView *)self.textInput;
        [attrStr appendAttributedString:textView.attributedText];
        [attrStr appendAttributedString:attrStringWithImage];
        textView.attributedText = attrStr;
        NSLog(@"%@", text);
        
    }
        else if ([text  isEqualToString:@"Angel" ]){
            
            
//            NSTextAttachment *textAttachment = [[NSTextAttachment alloc] init];
//            
//            NSURL *url = [[NSBundle mainBundle] URLForResource:text withExtension:@"gif"];
