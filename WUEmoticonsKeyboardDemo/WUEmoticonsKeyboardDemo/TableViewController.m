...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        switch (indexPath.row) {
            ...
            case 1:
            {
                TestChatViewController *vc = [TestChatViewController messagesViewController];
...
//            case 1:
//            {
//                TestChatViewController *vc = [DemoMessagesViewController messagesViewController];
...
- (void)JSQTestChatViewControllerDelegate:(TestChatViewController *)vc
{
